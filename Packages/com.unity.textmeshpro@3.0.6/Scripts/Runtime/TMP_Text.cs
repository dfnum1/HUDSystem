...
namespace TMPro
{
    ...
    public abstract class TMP_Text : MaskableGraphic
    {
        ...
        protected virtual void SaveGlyphVertexInfo(float padding, float style_padding, Color32 vertexColor)
        {
            ...
            Vector2 size = m_textInfo.characterInfo[m_characterCount].vertex_TR.position - m_textInfo.characterInfo[m_characterCount].vertex_BL.position;
            #endregion
        ...
        internal TMP_TextElement GetTextElement(uint unicode, TMP_FontAsset fontAsset, FontStyles fontStyle, FontWeight fontWeight, out bool isUsingAlternativeTypeface)
        {
            ...
            if (character == null)
            {
                character = TMP_FontAssetUtilities.GetCharacterFormSysFont(unicode, m_FontStyleInternal, m_FontWeightInternal, out isUsingAlternativeTypeface);
            }

...
namespace Unity.Collections.LowLevel.Unsafe
{
        ...
        where TValue : struct
    {
        ...
        internal static unsafe bool TryAdd(UnsafeHashMapData* data, TKey key, TValue item, bool isMultiHashMap, AllocatorManager.AllocatorHandle allocation, out int idx)
        {
            TValue tempItem;
            idx = 0;
            NativeMultiHashMapIterator<TKey> tempIt;
